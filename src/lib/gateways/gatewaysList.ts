...
export const gatewaysList: GatewayConfig[] = [
  ...
  // 56. FUSIONPAY
  {
    ...
    name: "FusionPay",
    slug: "fusionpay",
    logo: "https://fusionpay.com/logo.png",
    type: "nacional",
    status: "active",
    description: "Gateway de pagamento com Pix, Cartão de Crédito e Boleto com taxas atrativas.",
    features: ["Pix", "Cartão de Crédito", "Boleto"],
    paymentMethods: ["pix", "credit_card", "boleto"],
    configFields: [
      {
    ...
    apiDocs: "https://fusionpay.com/docs",
    testMode: true,
  },
  // 57. INFINITEPAY
  {
    ...
    name: "InfinitePay",
    slug: "infinitepay",
    logo: "https://www.infinitepay.io/blog/wp-content/uploads/2022/03/Infinitepay-Logo-1.svg",
    type: "nacional",
    status: "active",
    description: "Checkout Integrado com Pix e Cartão de Crédito em até 12x via CloudWalk.",
    ...
    apiDocs: "https://www.infinitepay.io/desenvolvedores",
    testMode: true,
  },
  // 58. PAGHIPER
  {
    ...
    name: "PagHiper",
    slug: "paghiper",
    logo: "https://www.paghiper.com/wp-content/uploads/2023/07/paghiper-logo.svg",
    type: "nacional",
    status: "active",
    description: "Gateway brasileiro especialista em Boleto e Pix.",
    features: ["Boleto", "Pix"],
    ...
    apiDocs: "https://dev.paghiper.com",
    testMode: true,
  },
  // 59. OPENPIX (WOOVI)
  {
    ...
    name: "OpenPix (Woovi)",
    slug: "openpix",
    logo: "https://developers.woovi.com/img/logo.png",
    type: "nacional",
    status: "active",
    description: "Plataforma de pagamento PIX e QR Codes dinâmicos da Woovi.",
    features: ["Pix"],
    paymentMethods: ["pix"],
    configFields: [
      {
    ...
    apiDocs: "https://developers.woovi.com",
    testMode: true,
  },
  // 60. MAXIPAGO
  {
    ...
    name: "MaxiPago!",
    slug: "maxipago",
    logo: "https://www.maxipago.com/wp-content/themes/maxipago/images/logo.png",
    type: "nacional",
    status: "active",
    description: "Processamento de pagamentos com cartão de crédito via API XML.",
    features: ["Cartão de Crédito", "Cartão de Débito"],
    paymentMethods: ["credit_card", "debit_card"],
    configFields: [
      {
        name: "merchantId",
    ...
    apiDocs: "https://www.maxipago.com/developers/apidocs/",
    testMode: true,
  },
  // 61. SAFRAPAY
  {
    ...
    name: "SafraPay",
    slug: "safrapay",
    logo: "https://www.safrapay.com.br/assets/logo-safrapay.svg",
    type: "nacional",
    status: "active",
    description: "Gateway de pagamentos do Banco Safra para crédito, débito e Pix.",
    features: ["Cartão de Crédito", "Cartão de Débito", "Pix"],
    paymentMethods: ["credit_card", "debit_card", "pix"],
    configFields: [
      {
    ...
    apiDocs: "https://www.safrapay.com.br/desenvolvedor",
    testMode: true,
  },
  // 62. ROXPAY
  {
    ...
    name: "RoxPay",
    slug: "roxpay",
    logo: "https://www.roxpay.eu/assets/images/logo.svg",
    type: "both",
    status: "active",
    description: "Gateway europeu/brasileiro de pagamentos online com Pix, Cartão de Crédito e Boleto.",
    features: ["Cartão de Crédito", "Pix", "Boleto"],
    paymentMethods: ["credit_card", "pix", "boleto"],
    configFields: [
      {
        name: "clientId",
        ...
        type: "text",
        required: true,
        placeholder: "Crie no painel de desenvolvedores RoxPay",
      },
      {
        name: "clientSecret",
        label: "Client Secret",
      ...
      },
      {
        ...
        type: "text",
        required: false,
        placeholder: "Para parceiros / sub-contas",
      },
      {
        name: "isTestMode",
        label: "Modo Sandbox",
    ...
    apiDocs: "https://app.roxpay.eu/apidocs/",
    testMode: true,
  },
];

// Map implemented flag dynamically for Sprint 1
const IMPLEMENTED_SLUGS = ["asaas", "mercado-pago", "mercadopago", "pagseguro", "pagarme", "pagouai", "hypercash", "bestfy", "blackcat", "efi", "dompagamentos", "fastpay", "appmax", "everpay", "bynet", "brazapay", "diasmarketplace", "iugu", "vindi", "cielo", "stone", "picpay", "paypal", "rede", "getnet", "wirecard", "safetypay", "azcend", "paguex", "allus", "alpa", "alphacash", "anubispay", "asset", "astonpay", "atlaspay", "axelpay", "axionpay", "bravospay", "carthero", "centurionpay", "codiguzhub", "credpago", "credwave", "cupulahub", "cyberhub", "dorapag", "dubaipay", "firepag", "fivepay", "flashpay", "flowspay", "flypayments", "fortrex", "freepay", "stripe", "fusionpay", "infinitepay", "paghiper", "openpix", "maxipago", "safrapay", "roxpay", "adyen", "braintree", "checkoutcom", "square", "klarna", "authorizenet", "payu", "dlocal", "ebanx", "juno", "zoop", "galaxpay", "starkbank", "celcoin", "pjbank", "boletosimples", "transfeera", "shipay", "dock", "hotmart", "eduzz", "monetizze", "kiwify", "perfectpay", "yampi", "ame", "nuvei", "mundipagg", "nupay", "bradesco", "bancodobrasil", "santander", "sicoob", "cora", "fitbank", "velipag", "sipag", "zeroum", "payly", "payoneer", "skrill", "neteller", "webmoney", "perfectmoney"];
