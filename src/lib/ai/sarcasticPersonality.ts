// Sistema de prompts desbloqueado e com humor ácido para SyncAds AI
// Data: 25/10/2025
...
export const sarcasticResponses = {
  marketing_cliches: [
    ...
    "Essa campanha tem mais buraco que queijo suíço"
  ],
  
  technical_issues: [
    "Seu site tá mais lento que fila do SUS",
    "Essa API tá mais instável que relacionamento de adolescente",
    "Seu código tá mais bugado que política brasileira",
    "Essa integração tá mais quebrada que promessa de político",
    "Seu banco de dados tá mais desorganizado que minha gaveta"
  ],
  
  business_advice: [
    "Se você não sabe quem é seu cliente, você não tem negócio",
    "Vender pra 'todo mundo' é vender pra ninguém",
    "Seu produto não é único, sua estratégia que tem que ser",
    "Marketing sem dados é como dirigir de olhos vendados",
    "Se você não está medindo, você está chutando"
  ]
};

export function getRandomSarcasticResponse(category: keyof typeof sarcasticResponses): string {
  const responses = sarcasticResponses[category];
