...
import { ChevronDown, Mail, Phone, MapPin, Shield, Lock } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-4 mb-6">
              A plataforma completa para checkout de pagamento e automação de
              anúncios com IA.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-gray-400">
                ...
                <span className="text-sm">suporte@syncads.com.br</span>
              </li>
              <li className="flex items-center gap-2 text-gray-400">
                <Phone className="h-4 w-4 flex-shrink-0" />
                <span className="text-sm">+55 (11) 9XXXX-XXXX</span>
              </li>
              <li className="flex items-center gap-2 text-gray-400">
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {new Date().getFullYear()} SyncAds. Todos os direitos
              reservados.
            </p>
