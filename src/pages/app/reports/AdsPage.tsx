    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-1 text-sm">(0 Anúncios)</p>
        ...
        <div className="flex items-center gap-2">
          <Input value={dateRange} readOnly className="w-72" />
        </div>
      </div>
        ...
        <CardContent className="p-0">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {MOCK_ADS.map((ad) => (
                  <tr key={ad.id} className="border-b hover:bg-gray-50 dark:bg-gray-950">
