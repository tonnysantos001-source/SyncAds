...
const BillingPage: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    const variants: Record<string, { label: string; className: string }> = {
      active: { label: 'Ativa', className: 'bg-gradient-to-r from-green-500 to-emerald-600 text-white border-none' },
      trialing: { label: 'Trial', className: 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-none' },
      past_due: { label: 'Atrasada', className: 'bg-gradient-to-r from-orange-500 to-red-600 text-white border-none' },
      canceled: { label: 'Cancelada', className: 'bg-gradient-to-r from-gray-400 to-gray-600 text-white border-none' },
      paid: { label: 'Paga', className: 'bg-gradient-to-r from-green-500 to-emerald-600 text-white border-none' },
      open: { label: 'Aberta', className: 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-none' },
      void: { label: 'Cancelada', className: 'bg-gradient-to-r from-gray-400 to-gray-600 text-white border-none' },
    };

    const variant = variants[status] || { label: status, className: 'bg-gradient-to-r from-gray-400 to-gray-600 text-white border-none' };
                      ...
                      <div className="pt-4 border-t border-pink-200/50 dark:border-pink-800/50">
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="text-gray-600 dark:text-gray-400">
                            Renovação: <span className="font-semibold text-gray-900 dark:text-white">{formatDate(subscription.currentPeriodEnd)}</span>
                          </span>
                        </div>
                      </div>
                    )}
            ...
            <CardContent className="p-6">
              {paymentMethods.length > 0 ? (
                  ...
                  {paymentMethods.map((pm, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button variant="ghost" size="sm" className="hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-950/30">
                          Remover
                        </Button>
                      </div>
                    </motion.div>
                ...
                <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                  ...
                  <p className="font-semibold text-lg mb-1">Nenhum cartão cadastrado</p>
                  <p className="text-sm">Adicione um cartão para pagamentos futuros</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              {invoices.length > 0 ? (
                ...
                <div className="text-center py-16 text-gray-500 dark:text-gray-400">
                  ...
                  <p className="font-semibold text-lg mb-1">Nenhuma fatura emitida</p>
                  <p className="text-sm">Suas faturas aparecerão aqui quando forem geradas</p>
                </div>
              )}
            </CardContent>
          </Card>
