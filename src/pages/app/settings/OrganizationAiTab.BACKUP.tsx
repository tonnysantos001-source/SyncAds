    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configuração de IA da sua organização</CardDescription>
        </CardHeader>
        <CardContent className="py-12">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-gray-500 max-w-md mx-auto">
              Sua organização ainda não tem uma IA configurada. Entre em contato com o administrador do sistema.
            </p>
          </div>
        </CardContent>
      </Card>
            ...
            <div key={ai.id} className="border rounded-lg p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-medium">{ai.globalAiConnection.name}</h3>
                    {ai.isDefault && (
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-medium">{ai.globalAiConnection.model || 'Padrão'}</p>
                </div>
                <div>
                  <span className="text-gray-500">Max Tokens</span>
                  <p className="font-medium">{ai.globalAiConnection.maxTokens}</p>
                </div>
                <div>
                  <span className="text-gray-500">Temperature</span>
                  <p className="font-medium">{ai.globalAiConnection.temperature}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <CardContent className="pt-6">
          <div className="flex gap-3">
            ...
            <div className="text-sm">
              <p className="font-medium text-blue-900 mb-1">Gerenciamento de IA</p>
              <p className="text-blue-700">
                As conexões de IA são gerenciadas centralmente pelo administrador do sistema. 
                Se precisar de uma IA diferente ou tiver problemas, entre em contato com o suporte.
              </p>
            </div>
          </div>
        </CardContent>
