...
const CrossSellPage: React.FC = () => {
  const handleCadastrar = () => {
    console.log('Cadastrar cross sell');
  };
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-3">
                  Você ainda não tem nenhum cross sell cadastrado.
                </h1>
                <p className="text-gray-600 text-lg">
                  Que tal cadastrar seu primeiro cross sell para aumentar seu ticket médio?
                </p>
              </div>
