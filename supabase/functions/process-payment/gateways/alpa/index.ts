...
export class AlpaGateway extends BaseGateway {
  name = "Alpa";
  slug = "alpa";
  supportedMethods = [
  ...
  async validateCredentials(
    ...
    try {
      if (!credentials.clientId) {
        return {
          isValid: false,
          message: "clientId is required for Alpa",
        };
      }
      if (!credentials.clientSecret) {
        return {
          isValid: false,
          message: "clientSecret is required for Alpa",
        };
      }
  ...
  async processPayment(
    ...
    try {
      ...
      return this.createErrorResponse(error, "Failed to process Alpa payment");
    }
  }
  ...
  async handleWebhook(
    ...
    try {
      ...
      this.log("error", "Alpa webhook error", { error: error.message });
      return {
        success: false,
        processed: false,
        message: error.message,
