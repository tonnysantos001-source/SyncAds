...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Fortrex
   */
  ...
  /**
   * Converte a resposta da API do Fortrex para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Fortrex para resposta de status do SyncAds
   */
