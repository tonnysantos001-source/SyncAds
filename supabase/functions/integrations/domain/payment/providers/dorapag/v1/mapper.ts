...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Dorapag
   */
  ...
  /**
   * Converte a resposta da API do Dorapag para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Dorapag para resposta de status do SyncAds
   */
