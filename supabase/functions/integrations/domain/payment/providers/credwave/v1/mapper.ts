...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Credwave
   */
  ...
  /**
   * Converte a resposta da API do Credwave para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Credwave para resposta de status do SyncAds
   */
