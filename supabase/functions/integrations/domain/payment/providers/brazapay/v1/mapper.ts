...
export class Mapper {
  /**
   * Converte a request interna do SyncAds para o formato da API do Braza Pay
   */
  static toPaymentPayload(request: PaymentRequest): PaymentRequestPayload {
    ...
    const payload: PaymentRequestPayload = {
      amount: Math.round(request.amount * 100), // Braza Pay espera centavos
      currency: "BRL",
      customer: {
  ...
  /**
   * Converte a resposta da API do Braza Pay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta da API da Braza Pay para resposta de status do SyncAds
   */
  ...
  /**
   * Mapeia status da Braza Pay para status interno do SyncAds
   */
