...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do SafetyPay
   */
  ...
  /**
   * Converte a resposta da API do SafetyPay para o formato padronizado do SyncAds
   */
  static toPaymentResponse(response: PaymentResponsePayload): PaymentResponse {
    ...
    const result: PaymentResponse = {
      ...
      status,
      message: `Transação processada no SafetyPay com status: ${rawStatus}`,
    };
  ...
  /**
   * Converte a resposta de status da API do SafetyPay para resposta de status do SyncAds
   */
