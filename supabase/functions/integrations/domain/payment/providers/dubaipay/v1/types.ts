// Tipos específicos para a API Dubaipay
// Documentação: https://api.dubai-pay.com/docs

export interface Credentials {
  merchantId: string;  // Identificador do comerciante (utilizado na autenticação Bearer)
  apiToken: string;    // Token de API complementar
}
