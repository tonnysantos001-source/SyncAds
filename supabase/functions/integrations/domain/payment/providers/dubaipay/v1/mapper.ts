...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Dubaipay
   */
  ...
  /**
   * Converte a resposta da API do Dubaipay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Dubaipay para resposta de status do SyncAds
   */
