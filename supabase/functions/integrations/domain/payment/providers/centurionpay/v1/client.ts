...
export class Client {
  ...
  private getHeaders(): HeadersInit {
    // Cabeçalho de autorização segue o legado: Authorization: Bearer <merchantId>
    return {
  ...
  /**
   * Valida a conexão com a API do Centurion Pay
   */
  ...
  /**
   * Cria uma cobrança no Centurion Pay
   */
  ...
  /**
   * Consulta os detalhes de um pagamento no Centurion Pay
   */
