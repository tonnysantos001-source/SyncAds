...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Axion Pay
   */
  ...
  /**
   * Converte a resposta da API do Axion Pay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Axion Pay para resposta de status do SyncAds
   */
