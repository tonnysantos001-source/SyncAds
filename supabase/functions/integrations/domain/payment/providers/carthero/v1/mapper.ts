...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Carthero
   */
  ...
  /**
   * Converte a resposta da API do Carthero para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Carthero para resposta de status do SyncAds
   */
