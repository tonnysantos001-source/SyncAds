...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Allus
   */
  ...
  /**
   * Converte a resposta da API do Allus para o formato padronizado do SyncAds
   */
  static toPaymentResponse(response: PaymentResponsePayload): PaymentResponse {
    ...
    const result: PaymentResponse = {
      ...
      status,
      message: `Transação processada no Allus com status: ${rawStatus}`,
    };
  ...
  /**
   * Converte a resposta de status da API do Allus para resposta de status do SyncAds
   */
