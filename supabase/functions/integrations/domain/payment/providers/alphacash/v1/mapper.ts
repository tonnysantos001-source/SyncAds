...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Alphacash
   */
  ...
  /**
   * Converte a resposta da API do Alphacash para o formato padronizado do SyncAds
   */
  static toPaymentResponse(response: PaymentResponsePayload): PaymentResponse {
    ...
    const result: PaymentResponse = {
      ...
      status,
      message: `Transação processada no Alphacash com status: ${rawStatus}`,
    };
  ...
  /**
   * Converte a resposta de status da API do Alphacash para resposta de status do SyncAds
   */
