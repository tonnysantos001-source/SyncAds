...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do CredPago
   */
  ...
  /**
   * Converte a resposta da API do CredPago para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do CredPago para resposta de status do SyncAds
   */
