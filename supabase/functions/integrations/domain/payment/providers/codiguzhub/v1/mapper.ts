...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Codiguz Hub
   */
  ...
  /**
   * Converte a resposta da API do Codiguz Hub para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Codiguz Hub para resposta de status do SyncAds
   */
