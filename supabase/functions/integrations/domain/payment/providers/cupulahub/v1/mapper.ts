...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Cupulahub
   */
  ...
  /**
   * Converte a resposta da API do Cupulahub para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Cupulahub para resposta de status do SyncAds
   */
