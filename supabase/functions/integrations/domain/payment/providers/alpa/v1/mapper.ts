...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Alpa
   */
  ...
  /**
   * Converte a resposta da API do Alpa para o formato padronizado do SyncAds
   */
  static toPaymentResponse(response: PaymentResponsePayload): PaymentResponse {
    ...
    const result: PaymentResponse = {
      ...
      status,
      message: `Transação processada no Alpa com status: ${rawStatus}`,
    };
  ...
  /**
   * Converte a resposta de status da API do Alpa para resposta de status do SyncAds
   */
