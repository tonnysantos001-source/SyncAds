...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do FlashPay
   */
  ...
  /**
   * Converte a resposta da API do FlashPay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do FlashPay para resposta de status do SyncAds
   */
