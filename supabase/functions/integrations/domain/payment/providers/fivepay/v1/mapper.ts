...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Fivepay
   */
  ...
  /**
   * Converte a resposta da API do Fivepay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Fivepay para resposta de status do SyncAds
   */
