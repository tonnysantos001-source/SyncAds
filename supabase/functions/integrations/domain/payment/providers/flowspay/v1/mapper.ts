...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Flowspay
   */
  ...
  /**
   * Converte a resposta da API do Flowspay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Flowspay para resposta de status do SyncAds
   */
