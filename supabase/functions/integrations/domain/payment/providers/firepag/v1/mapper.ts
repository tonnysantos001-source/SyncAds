...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Fire Pag
   */
  ...
  /**
   * Converte a resposta da API do Fire Pag para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Fire Pag para resposta de status do SyncAds
   */
