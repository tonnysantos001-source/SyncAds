...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Fly Payments
   */
  ...
  /**
   * Converte a resposta da API do Fly Payments para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Fly Payments para resposta de status do SyncAds
   */
