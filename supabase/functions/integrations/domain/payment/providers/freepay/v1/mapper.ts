...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do FreePay
   */
  ...
  /**
   * Converte a resposta da API do FreePay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do FreePay para resposta de status do SyncAds
   */
