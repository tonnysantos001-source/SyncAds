...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Cyberhub
   */
  ...
  /**
   * Converte a resposta da API do Cyberhub para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Cyberhub para resposta de status do SyncAds
   */
