...
export class Mapper {
  ...
  /**
   * Converte a request interna do SyncAds para o formato da API do Axelpay
   */
  ...
  /**
   * Converte a resposta da API do Axelpay para o formato padronizado do SyncAds
   */
  ...
  /**
   * Converte a resposta de status da API do Axelpay para resposta de status do SyncAds
   */
